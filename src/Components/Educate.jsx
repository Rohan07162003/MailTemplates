...
export default function Educate() {
    return (
        <div className="p-1 md:w-3/4 lg:w-2/3">
            <h2 className="font-semibold mb-3 mt-1 text-lg">Educate & Inform</h2>
            <div className="grid gap-x-2 gap-y-4 grid-cols-2 lg:grid-cols-3 mt-6 lg:mr-16">
